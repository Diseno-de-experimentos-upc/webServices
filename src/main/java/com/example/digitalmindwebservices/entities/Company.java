...
public class Company extends User {
    ...
    public Company(Long id, String firstName, String lastName, String email,
                   String phone, String password, String role, String description,
                   String image, String bannerImage, String ruc, String owner, String name,
    ...
    public Company(Long id, String firstName, String lastName, String email,
                   String phone, String password, String role, String description,
                   String image, String bannerImage, String ruc, String owner, String name,
                   String address, String country, String city, Integer rate) {
